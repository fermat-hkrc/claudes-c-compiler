# Bug: encode_rev silently ignores a third operand
**Law:** REV takes exactly two register operands; an extra operand must be rejected (llvm-mc / GNU as reject `rev w0, w1, w2`).
...
**Severity:** medium
**Regression test:** src/backend/arm/assembler/encoder/bitfield.rs `test_encode_rev_regression_extra_operand`
